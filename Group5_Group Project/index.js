...
const fetchExaminerController = require("./controllers/fetchExaminerController");
const saveExaminerInfoController = require("./controllers/saveExaminerInfoController");
...
// Database connection
mongoose.connect('mongodb+srv://venkatlavu98:kOTbtx3eLBIQTwXm@cluster0.wl3xhj5.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0');
...
//Route 22
app.post("/setExaminerInfo", saveExaminerInfoController);

//Route 23
app.get('/getExaminerUserInfo', fetchExaminerController );
